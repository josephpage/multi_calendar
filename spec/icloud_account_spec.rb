    ...
    describe "api calls" do
      ...
      describe "#list_events" do
        it "should list events" do
          ...
          expect(@icloud_account.list_events(
                     ...
                     calendar_ids: ['/207958951/calendars/']
                 )).to eq([{"id" => "20150108T163000Z-1037563606@iclouddav.com", "summary" => "Hello", "location" => "", "description" => "", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}, {:displayName => "", :responseStatus => "NEEDS-ACTION", :email => "nicolas@wepopp.com"}], "htmlLink" => "/207958951/calendars/home/20150108T163000Z-1037563606.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-08T16:30:00+00:00"}, "end" => {"dateTime" => "2015-01-08T18:30:00+00:00"}, "all_day" => false},
                           {"id" => "20150109T090000Z-7016265254", "summary" => "Gouter", "location" => "Ouche", "description" => "Aahah", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}, {:displayName => "", :responseStatus => "NEEDS-ACTION", :email => "nicolas@wepopp.com"}, {:displayName => "", :responseStatus => "NEEDS-ACTION", :email => "elrandil@gmail.com"}], "htmlLink" => "/207958951/calendars/home/20150109T090000Z-7016265254.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-09T09:00:00+00:00"}, "end" => {"dateTime" => "2015-01-09T10:00:00+00:00"}, "all_day" => false},
                           {"id" => "20150108T123000Z-9659696895@iclouddav.com", "summary" => "Hello 24", "location" => "", "description" => "", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}], "htmlLink" => "/207958951/calendars/home/20150108T123000Z-9659696895.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-08T12:30:00+00:00"}, "end" => {"dateTime" => "2015-01-08T13:30:00+00:00"}, "all_day" => false},
                           {"id" => "20150108T150000Z-6600987885", "summary" => "Yoyo", "location" => "", "description" => "", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}], "htmlLink" => "/207958951/calendars/home/20150108T150000Z-6600987885.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-08T15:00:00+00:00"}, "end" => {"dateTime" => "2015-01-08T16:00:00+00:00"}, "all_day" => false},
                           {"id" => "20150109T110000Z-9005638381", "summary" => "Midi real", "location" => "Dans le midi", "description" => "", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}], "htmlLink" => "/207958951/calendars/home/20150109T110000Z-9005638381.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-09T11:00:00+00:00"}, "end" => {"dateTime" => "2015-01-09T12:00:00+00:00"}, "all_day" => false},
                           {"id" => "20150110T120000Z-2943239791", "summary" => "Ho", "location" => "", "description" => "", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}], "htmlLink" => "/207958951/calendars/home/20150110T120000Z-2943239791.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-10T12:00:00+00:00"}, "end" => {"dateTime" => "2015-01-10T13:00:00+00:00"}, "all_day" => false},
                           {"id" => "20150110T120000Z-3141510784", "summary" => "Ho", "location" => "", "description" => "", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}], "htmlLink" => "/207958951/calendars/home/20150110T120000Z-3141510784.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-10T12:00:00+00:00"}, "end" => {"dateTime" => "2015-01-10T13:00:00+00:00"}, "all_day" => false},
                           ...
                           {"id" => "20150112T150000Z-5758768501", "summary" => "Test de rdv", "location" => "", "description" => "", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}], "htmlLink" => "/207958951/calendars/home/20150112T150000Z-5758768501.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-12T15:00:00+00:00"}, "end" => {"dateTime" => "2015-01-12T16:00:00+00:00"}, "all_day" => false},
                           {"id" => "20150108T090000Z-0129917367", "summary" => "Hahah", "location" => "", "description" => "", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}], "htmlLink" => "/207958951/calendars/home/20150108T090000Z-0129917367.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-08T09:00:00+00:00"}, "end" => {"dateTime" => "2015-01-08T10:00:00+00:00"}, "all_day" => false},
                           {"id" => "20150108T120000Z-6867438624", "summary" => "Hahah", "location" => "", "description" => "", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}], "htmlLink" => "/207958951/calendars/home/20150108T120000Z-6867438624.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-08T12:00:00+00:00"}, "end" => {"dateTime" => "2015-01-08T13:00:00+00:00"}, "all_day" => false},
                           {"id" => "20150109T133000Z-6839699524", "summary" => "Soirée", "location" => "Chez moi", "description" => "", "attendees" => [{:displayName => "", :responseStatus => "Unknown", :email => "nicolas.marlier@wanadoo.fr", :organizer => true}, {:displayName => "", :responseStatus => "DECLINED", :email => "nicolas@wepopp.com"}], "htmlLink" => "/207958951/calendars/home/20150109T133000Z-6839699524.ics", "calId" => "/207958951/calendars/", "private" => false, "owned" => true, "start" => {"dateTime" => "2015-01-09T13:30:00+00:00"}, "end" => {"dateTime" => "2015-01-09T14:30:00+00:00"}, "all_day" => false},
      ...
      describe "#get_event" do
        before do
          ...
          stub_request(:report, "https://marck%40zuck.com:password@p01-caldav.icloud.com/207958951/calendars/").
              with(:body => "        <c:calendar-multiget xmlns:d=\"DAV:\"\n        xmlns:c=\"urn:ietf:params:xml:ns:caldav\">\n          <d:prop>\n            <c:calendar-data />\n          </d:prop>\n          <c:filter>\n            <c:comp-filter name=\"VCALENDAR\" />\n          </c:filter>\n          <d:href>/207958951/calendars/home/20150109T133000Z-6839699524.ics</d:href>\n        </c:calendar-multiget>\n").
              to_return(:status => 200, :body => "<?xml version='1.0' encoding='UTF-8'?><multistatus xmlns='DAV:'>\r\n<response xmlns='DAV:'>\r\n  <href>/207958951/calendars/home/20150109T133000Z-6839699524.ics</href>\r\n  <propstat>\r\n    <prop>\r\n      <calendar-data xmlns='urn:ietf:params:xml:ns:caldav'><![CDATA[BEGIN:VCALENDAR\r\nVERSION:2.0\r\nPRODID:-//CALENDARSERVER.ORG//NONSGML Version 1//EN\r\nBEGIN:VEVENT\r\nUID:20150109T133000Z-6839699524\r\nDTSTART:20150109T133000Z\r\nDTEND:20150109T143000Z\r\nSUMMARY:Soir\xC3\xA9e\r\nLOCATION:Chez moi\r\nDESCRIPTION:\r\nORGANIZER;CN=Organizer;EMAIL=nicolas.marlier@wanadoo.fr:\r\n /aMjA3OTU4OTUxMjA3OTU4OWySu79f4dSH4mIePT8HcARqUER4gwjTN-JRC0eyM3Og/princip\r\n al/\r\nATTENDEE;CN=Organizer;EMAIL=nicolas.marlier@wanadoo.fr;\r\n X-CALENDARSERVER-DTSTAMP=20150107T174020Z:\r\n /aMjA3OTU4OTUxMjA3OTU4OWySu79f4dSH4mIePT8HcARqUER4gwjTN-JRC0eyM3Og/princip\r\n al/\r\nATTENDEE;ROLE=REQ-PARTICIPANT;PARTSTAT=DECLINED;SCHEDULE-STATUS=2.0:\r\n mailto:nicolas@wepopp.com\r\nDTSTAMP:20150109T090846Z\r\nEND:VEVENT\r\nEND:VCALENDAR\r\n]]></calendar-data>\r\n    </prop>\r\n    <status>HTTP/1.1 200 OK</status>\r\n  </propstat>\r\n</response>\r\n</multistatus>\n", :headers => {})

          stub_request(:report, "https://marck%40zuck.com:password@p01-caldav.icloud.com/207958951/calendars/").
              with(:body => "        <c:calendar-multiget xmlns:d=\"DAV:\"\n        xmlns:c=\"urn:ietf:params:xml:ns:caldav\">\n          <d:prop>\n            <c:calendar-data />\n          </d:prop>\n          <c:filter>\n            <c:comp-filter name=\"VCALENDAR\" />\n          </c:filter>\n          <d:href>/207958951/calendars/home/20150109T133000Z-1345.ics</d:href>\n        </c:calendar-multiget>\n").
              to_return(:status => 200, :body => "<?xml version='1.0' encoding='UTF-8'?><multistatus xmlns='DAV:'>\r\n</multistatus>\n", :headers => {})
        ...
        context "event exists" do
          it "should get event" do
            expect(@icloud_account.get_event(
                       ...
                       event_url: "/207958951/calendars/home/20150109T133000Z-6839699524.ics"
                   )).to eq({
                                ...
                                "htmlLink" => "/207958951/calendars/home/20150109T133000Z-6839699524.ics",
        ...
        context "event does not exist" do
          it "should raise" do
            expect{@icloud_account.get_event(
                       calendar_id: '/207958951/calendars/',
                       event_url: "/207958951/calendars/home/20150109T133000Z-1345.ics"
